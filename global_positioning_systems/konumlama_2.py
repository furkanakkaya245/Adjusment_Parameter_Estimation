...
uydu_acilari = GNSS.tum_uydulari_hesapla(Sat_coor, GIRS_coor[0].item(),GIRS_coor[1].item(),GIRS_coor[2].item(), R)

# DOP DEGERLERİNİN HESAPLANMASI
GDOP, PDOP,HDOP,VDOP,TDOP=GNSS.uydu_DOP(Sat_coor,float(GIRS_coor[0].item()),float(GIRS_coor[1].item()),float(GIRS_coor[2].item()),R)
